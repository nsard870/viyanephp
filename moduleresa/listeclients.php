...
try {
    $total_clients_stmt = $pdo->query("SELECT COUNT(*) FROM clients");
...
// --- Fetch Clients (with LIMIT and OFFSET) ---
try {
    $reqsql = $pdo->prepare("SELECT * FROM clients ORDER BY nom, prenom LIMIT :limit OFFSET :offset");
    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="ajout_client.php" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Ajouter</a>
            </div>
            <div class="card-body">
